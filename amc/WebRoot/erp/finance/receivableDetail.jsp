...
<body>
	<div class="form_content_2">
		<fieldset>
			<legend>应收账款详情</legend>
			<div class="form-row">
				<div class="field-label">
					<label for="field1">应收账编号</label>
				</div>
				<div class="shortfield-widget">
					<input class="shortdetail" readonly="readonly" value="${rc.rcid }" />
				</div>
				<div class="field-label">
				...
				<div class="shortfield-widget">
					<input class="shortdetail" readonly="readonly"
						value="<fmt:formatDate value='${rc.rcctime}' pattern='yyyy-MM-dd'/>" />
				</div>
				<div class="field-label">
					<label for="field1">订单金额</label>
				</div>
				<div class="field-widget">
					<input class="detail" readonly="readonly" value="${rc.rctaccount }" />
				</div>
			</div>
			<div class="form-row">
				<div class="field-label">
				...
				<div class="shortfield-widget">
					<input class="shortdetail" readonly="readonly"
						value="<fmt:formatDate value='${rc.rcrtime}' pattern='yyyy-MM-dd'/>" />
				</div>
				<div class="field-label">
				...
				<div class="field-widget">
					<input class="detail" readonly="readonly"
						value="<fmt:formatDate value='${rc.rcdeadline}' pattern='yyyy-MM-dd'/>" />
				</div>
			</div>
		</fieldset>

		<fieldset>
			<legend>应收账款清单</legend>
