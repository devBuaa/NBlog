...
<body>
	<div class="form_content_2">
		<fieldset>
			<legend>销售业务账详情</legend>
			<div class="form-row">
				<div class="field-label">
					<label for="field1">账款编号</label>
				</div>
				<div class="shortfield-widget">
					<input class="shortdetail" readonly="readonly" value="${rc.said }" />
				</div>
				<div class="field-label">
				...
				<div class="field-widget">
					<input class="detail" readonly="readonly"
						value="<fmt:formatDate value='${rc.amcReceivable.rcctime}' pattern='yyyy-MM-dd'/>" />
				</div>
				<div class="field-label">
					<label for="field1">订单金额</label>
				</div>
				<div class="field-widget">
					<input class="detail" readonly="readonly" value="${rc.satotalaccount }" />
				</div>
			</div>
			<div class="form-row">
				<div class="field-label">
				...
				<div class="shortfield-widget">
					<input class="shortdetail" readonly="readonly"
						value="${rc.amcReceivable.amcSalesorder.soid }" />
				</div>
				
				<div class="field-label">
					<label for="field1">收货时间</label>
				</div>
				<div class="field-widget">
					<input class="detail" readonly="readonly"
						value="<fmt:formatDate value='${rc.amcReceivable.rcrtime}' pattern='yyyy-MM-dd'/>" />
				</div>
				<div class="field-label">
					<label for="field1">收款日期</label>
				</div>
				<div class="field-widget">
					<input class="detail" readonly="readonly"
						value="<fmt:formatDate value='${rc.amcReceivable.rcdeadline}' pattern='yyyy-MM-dd'/>" />
				</div>
			</div>
		</fieldset>
