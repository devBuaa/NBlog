...
public class JsonUtil {
	...
	public static void main(String[] args) {
		...
		List<AmcDepartment> departments=new ArrayList<AmcDepartment>();
		for(int i=0;i<10;i++){
			AmcDepartment department=new AmcDepartment();
			department.setId(i);
			department.setName("xsx");
			department.setDescription("djkhks");
			departments.add(department);
		}
		System.out.println(listToJson(departments));
